      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-8">
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="flex gap-4 mb-12">
                <a href="https://zekastack.dong4j.site/docs/arco-meta/" target="_blank" rel="noreferrer" className="inline-flex items-center px-4 py-2 bg-blue-50 text-blue-700 border border-blue-100 rounded-lg font-medium hover:bg-blue-100 transition-colors">
                    {t('modules.viewDocs')}
                </a>
